<template>
  <v-app id="main">
    ...
    <v-content>
      <v-app-bar v-if="isLoggedIn" class="app-bar" app dense elevation="0">
...
.submit-btn {
  box-shadow: 0 12px 20px -10px rgba(233, 30, 99, 0.28),
    0 4px 20px 0 rgba(0, 0, 0, 0.12), 0 7px 8px -5px rgba(233, 30, 99, 0.2) !important;
  background-image: linear-gradient(60deg, rgb(236, 64, 122), rgb(216, 27, 96));
  color: #fff !important;
  margin-bottom: 10px !important;
}
.goback-btn {
  box-shadow: 0 12px 20px -10px rgba(7, 229, 245, 0.317),
    0 4px 20px 0 rgba(0, 0, 0, 0.12), 0 7px 8px -5px rgba(12, 202, 245, 0.297) !important;
  background-color: #12cdef !important;
  color: #fff !important;
  border-radius: var(--btn-radius) !important;
}
.edit-btn {
  box-shadow: 0 12px 20px -10px rgba(255, 200, 3, 0.816),
    0 4px 20px 0 rgba(0, 0, 0, 0.12), 0 7px 8px -5px rgba(12, 202, 245, 0.297) !important;
